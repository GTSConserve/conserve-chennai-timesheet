...
class AddEmployee extends Component
{
    ...
    public $department, $category, $experience, $grade, $designation, $category_name;
    ...
    public function engReportingHead()
    {
        ...
        if ($this->experience == 10) {
            if ($this->grade == 3) {
                $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id',11)->get();
                }
                if ($this->grade == 2) {
                    $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id',10],['usergroup_grade_id',3]])->get();
                    }
                    if ($this->grade == 1) {
                        $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id',10],['usergroup_grade_id',2]])->get();
                        }
        }
        if ($this->experience == 9) {
            $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 10],['usergroup_grade_id',1]])->get();
        }
        if ($this->experience == 8) {
            $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id', 9)->get();
        }
        if ($this->experience == 7) {
            $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id', 8)->get();
        }
        if ($this->experience == 6) {
            $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id', 7)->get();
        }
        if ($this->experience == 5) {
            $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id', 6)->get();
        }
        if ($this->experience == 4) {
            $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id', 5)->get();
        }
        if ($this->experience == 3) {
            if ($this->grade == 4) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 4], ['usergroup_grade_id', 7]])->get();
            }
            if ($this->grade == 5) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 4], ['usergroup_grade_id', 8]])->get();
            }
            if ($this->grade == 6) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 4], ['usergroup_grade_id', 9]])->get();
            }
        }
        if ($this->experience == 2) {
            if ($this->grade == 1) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 3], ['usergroup_grade_id', 4]])->get();
            }
            if ($this->grade == 2) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 3], ['usergroup_grade_id', 5]])->get();
            }
            if ($this->grade == 3) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 3], ['usergroup_grade_id', 6]])->get();
            }
        }
        if ($this->experience == 1) {
            if ($this->grade == 1) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 2], ['usergroup_grade_id', 1]])->get();
            }
            if ($this->grade == 2) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 2], ['usergroup_grade_id', 2]])->get();
            }
            if ($this->grade == 3) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 2], ['usergroup_grade_id', 3]])->get();
            }
        }
    }
    public function adminReportingHead()
    {
        $this->reporting_heads = User::where('usergroup_department_id', $this->department);
        if ($this->experience == 11) {
            $this->reporting_heads = $this->reporting_heads->where('usergroup_experience_id','=',NULL)->get();
        ...
        if ($this->experience == 10) {
            if ($this->grade == 2) {
                ...
                if ($this->grade == 1) {
                    $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id',11],['usergroup_grade_id',2]])->get();
                    }
        ...
        if ($this->experience == 3) {
            if ($this->grade == 3) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 4], ['usergroup_grade_id', 5]])->get();
            }
            if ($this->grade == 4) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 4], ['usergroup_grade_id', 6]])->get();
            }
        
        }
        if ($this->experience == 2) {
            if ($this->grade == 1) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 3], ['usergroup_grade_id', 3]])->get();
            }
            if ($this->grade == 2) {
                $this->reporting_heads = $this->reporting_heads->where([['usergroup_experience_id', 3], ['usergroup_grade_id', 4]])->get();
            }
    ...
    public function render()
    {
        ...
        if ($this->experience) {
            ...
            $this->category = $experience->usergroup_category_id;
            ...
            $user_group_desiginations = UsergroupDesigination::where([['usergroup_department_id', $this->department], ['usergroup_experience_id', $this->experience]])->get();
