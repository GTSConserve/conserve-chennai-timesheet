<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <img  src="{{asset('assets/img/conserve.png')}}" style="height:50px;">
            {{-- <a class="navbar-brand" href="index.html"><img alt="logo" src="assets/img/90x90.jpg"> <span class="navbar-brand-name"></span></a> --}}
        </div>
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            @csrf
                            <button style="background:#fff;border:none;"class="mt-1 mx-2 mb-1">
