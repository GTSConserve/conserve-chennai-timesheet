                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    @if ($project_details->name !="")
                                        <p style="font-size:20px;" id="lable"><b>Project Name : {{$project_details->name}}</b></p>
                                    @endif
                                </div>
                                <div class="col-sm-6">
                                    <div class=""><p id="lable" class="text-right" style="font-size:20px;"><b>Employees : {{$emp_count}}</b></p></div>
                                </div>
                            </div>
                            <div class="row p-3">
